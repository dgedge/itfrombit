...
Self-asserting on the robust facts; honest verdict.  numpy only.
"""
import sys
import numpy as np
...
print("Quantities needing a NEW energy scale (a_V's eps, a_A's symmetry potential,")
print("a_P's pairing gap) stay open. Item 113: a_C grounded + a_S/a_V geometric +")
print("a_A half; the absolute a_V/a_S/a_A/a_P scales remain Horizon.")
