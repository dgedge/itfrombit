...
tensors are suppressed (r ~ 2e-9) and the picture closes. This script is the first rigorous rung.
...
[verdict] NO-SQUEEZING RUNG 1 ESTABLISHED (the mechanism). The graviton is the substrate's
  ...
  printing has no graviton to squeeze: tensors are suppressed, scalars (compression) are not.
