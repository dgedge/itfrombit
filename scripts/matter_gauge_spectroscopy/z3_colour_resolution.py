"""Z3 colour-centre and triality audit.

Builds the GL(2,F2) action on the two colour bits, checks the order-3
triality, and records the colour-blind charge/CPT resolution used by the
anomaly-compression paper.
"""
