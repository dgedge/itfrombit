...
Item 113 (ANCHOR §15): baseline attempt to derive the five Weizsacker SEMF coefficients
...
This is the pre-contact-scale baseline.  Later audits
item113_nuclear_absolute_scale_audit.py and
item113_weizsaecker_theorem_candidates.py conditionally ground the saturated
contact scale eps_sat=2 alpha0 Lambda_QCD, and
item113_t1_t2_local_map_theorems.py supplies the local 13/12 and rank-five
maps.  This file is retained to show why naive pairwise bond-counting alone
does not close the chart.
...
print("  a_V, a_S            -> NOT pinned by this baseline bond-counting audit.")
print("     Later item113_nuclear_absolute_scale_audit.py conditionally grounds")
print("     eps_sat=2 alpha0 Lambda_QCD; item113_t1_t2_local_map_theorems.py")
print("     supplies the local T1 bulk 13/12 map.")
print("  a_A (I3 matching), a_P (chi parity) -> NOT pinned here: the local-map")
print("     audit supplies the later rank-five matching map.")
...
print("  * naive pairwise bonding does not close a_V, a_S, a_A, a_P.")
print("Full parameter-free SEMF stays Horizon-class; newer contact-scale audits")
print("promote the ~5 MeV saturated contact to conditional/model grade.")
