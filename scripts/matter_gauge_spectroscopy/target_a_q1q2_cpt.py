"""CPT and weak-target audit for the anomaly-compression readout.

Shows why the historical one-hot colour contribution to electric charge is
not CPT-covariant, and verifies that the weak coin uniquely flips the I3 bit.
"""
