"""Colour-count anomaly audit for Target A.

Scans the number of colours N_c in the one-generation SM representation
pattern and verifies that the anomaly equations force N_c = 3.
"""
