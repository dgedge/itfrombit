...
presupposed.
  ...
  * 'Why complex Hilbert space' is not derived: the substrate is a qubit (complex) QEC system by
    ...
    [UPDATE 2026-06-20: this relocation is now REDUCED, not left as a bare premise --
    substrate-locality => local tomography => complex C (Hardy/CDP), with the walk's continuous
    reversibility excluding the classical simplex; the computed R/C/H/simplex discriminator is in
    r4_complex_local_tomography_theorem.py. 'Why complex' is thereby de-relocated to R0 locality.]
